...
alignstr='%dx%d+%d+%d' % (width,height,(screenwidth - width) / 2, (screenwidth - width) / 2)
...
# brightness
bright = Label(root, text="Brightness:", font=("ariel 17 bold"),bg='#D5CABD')
...
canvas2 = Canvas(root, width="500", height="420", relief=RIDGE, bd=2)
